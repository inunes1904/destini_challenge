...
//DONE: Step 23 - Use the storyNumber property inside getStory(), getChoice1() and getChoice2() so
...
//DONE: Step 17 - Create a method called nextStory(), it should not have any outputs but
// it should have 1 input called choiceNumber which will be the choice number (int) made by the user.
  void nextStory(int n){
    ...
    switch (_storyNumber) {
      case 0:
        _storyNumber = (n == 1) ? 2 : 1;
        break;
      case 1:
        _storyNumber = (n == 1) ? 2 : 3;
        break;
      case 2:
        _storyNumber = (n == 1) ? 5 : 4;
        break;
      case 3 || 4 || 5:
        restart();
        break;
